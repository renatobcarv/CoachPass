...
const personalNavItems = [
  ...
  { to: '/personal/periodizacao', icon: BarChart3, label: 'Periodização' },
  { to: '/personal/metas', icon: Target, label: 'Prescrição de Metas' },
  { to: '/personal/questionarios', icon: ClipboardCheck, label: 'Questionários' },
  { to: '/personal/financeiro', icon: DollarSign, label: 'Financeiro' },
  { to: '/personal/cursos', icon: BookOpen, label: 'Cursos' },
  { to: '/personal/canvas', icon: Palette, label: 'Canvas' },
...
const nutritionistNavItems = [
  ...
  { to: '/nutritionist/questionarios', icon: ClipboardCheck, label: 'Questionários' },
  { to: '/nutritionist/alimentos', icon: Apple, label: 'Base de Alimentos' },
  { to: '/nutritionist/metas', icon: Target, label: 'Prescrição de Metas' },
  { to: '/nutritionist/materno-infantil', icon: Baby, label: 'Materno-Infantil' },
  { to: '/nutritionist/financeiro', icon: DollarSign, label: 'Financeiro' },
  { to: '/nutritionist/cursos', icon: BookOpen, label: 'Cursos' },
  { to: '/nutritionist/canvas', icon: Palette, label: 'Canvas' },
