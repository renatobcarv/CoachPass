...
const mockSessions: Session[] = [
  { id: '1', studentId: '2', studentName: 'Maria Santos', studentAvatar: 'https://ui-avatars.com/api/?name=Maria+Santos&background=3b82f6&color=fff', date: fmt(today), time: '19:00', duration: 60, type: 'presencial', location: 'Academia FitSync', plan: 'Funcional', status: 'scheduled', notes: '', recurring: true },
  { id: '2', studentId: '1', studentName: 'Lucas Silva', studentAvatar: 'https://ui-avatars.com/api/?name=Lucas+Silva&background=10b981&color=fff', date: fmt(today), time: '14:30', duration: 60, type: 'presencial', location: 'Academia FitSync', plan: 'Push/Pull/Legs', status: 'done', notes: 'Treino concluído com bom desempenho.', recurring: false },
  { id: '3', studentId: '3', studentName: 'Carlos Ramos', studentAvatar: 'https://ui-avatars.com/api/?name=Carlos+Ramos&background=f59e0b&color=fff', date: fmt(today), time: '08:00', duration: 45, type: 'presencial', location: 'Academia FitSync', plan: 'HIIT', status: 'done', notes: '', recurring: true },
  { id: '4', studentId: '4', studentName: 'Ana Oliveira', studentAvatar: 'https://ui-avatars.com/api/?name=Ana+Oliveira&background=8b5cf6&color=fff', date: fmt(new Date(today.getTime() + 86400000)), time: '10:00', duration: 60, type: 'presencial', location: 'Academia FitSync', plan: 'Mobilidade', status: 'scheduled', notes: '', recurring: false },
  { id: '5', studentId: '1', studentName: 'Lucas Silva', studentAvatar: 'https://ui-avatars.com/api/?name=Lucas+Silva&background=10b981&color=fff', date: fmt(new Date(today.getTime() + 86400000)), time: '07:00', duration: 60, type: 'presencial', location: 'Academia FitSync', plan: 'Pull B', status: 'scheduled', notes: '', recurring: true },
...
export function PersonalAgenda() {
  ...
  const [form, setForm] = useState({
    ...
    type: 'presencial', location: 'Academia FitSync', plan: '', notes: '', recurring: false,
  });
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input type="text" value={form.location} onChange={e => setForm(f => ({ ...f, location: e.target.value }))}
                    placeholder="Academia FitSync ou link do Meet"
                    className="w-full px-3 py-2.5 rounded-xl text-sm dark:bg-zinc-800 bg-slate-50 border dark:border-zinc-700 border-slate-200 dark:text-white text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500/30" />
                </div>
